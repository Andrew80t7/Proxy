...
def proxy():
    ...
    if 'text/html' in content_type.lower():
        ...
        final_html = rewrite_links(cleaned_html, url, embed_ads=True, flag=flag)
        return Response(final_html, headers={'Content-Type': 'text/html; charset=utf-8'})
...
if __name__ == '__main__':
    ...
    start_url = 'http://www.realto.ru/journal/articles/interesnye-fakty-o-kazino/'
    webbrowser.open(f'http://127.0.0.1:5000/?url={urllib.parse.quote_plus(start_url)}&embed_ads=1')
