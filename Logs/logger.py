...
# Устанавливаем минимальный уровень логирования для этого логгера (DEBUG –
# самый низкий уровень, будет записываться всё)
...
# Устанавливаем уровень логирования для вывода в консоль (INFO – будет
# выводиться информация и более высокие уровни)
